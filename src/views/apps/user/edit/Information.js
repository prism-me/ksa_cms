...
const languages = [
  { value: "english", label: "English", color: "#e65550 " },
  { value: "french", label: "French", color: "#e65550 " },
  { value: "spanish", label: "Spanish", color: "#e65550 " },
  { value: "russian", label: "Russian", color: "#e65550 " },
  { value: "italian", label: "Italian", color: "#e65550 " }
]

const colourStyles = {
  control: styles => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#e65550 "
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#e65550 ")
      }
    }
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#e65550 "
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#e65550 ",
      color: "white"
    }
  })
}

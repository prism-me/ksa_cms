  ...
  return (
    <div className="d-flex flex-wrap justify-content-between">
      <div className="add-new">
        <Button.Ripple
          color="primary"
          onClick={() => props.history.push("/blog-item/form")}
        >
          Add New
        </Button.Ripple>
      </div>
  ...
  state = {
    columns: [
      ...
      },
      {
        ...
        sortable: true,
        cell: (row) => <p className="text-bold-500 mb-0">{row.category_id}</p>,
      },
        ...
        cell: (row) => (
          <p className="text-bold-500 mb-0">
            ...
            <MdEdit
              ...
              onClick={() => {
                this.props.history.push(`/blog-item/form/${row.route}`);
              }}
    ...
    if (value.length) {
      filteredData = data.filter((item) => {
        ...
        let includesCondition =
          ...
          item.categories?.title.toLowerCase().includes(value?.toLowerCase()) ||
